...
public class SalesController {
	...
	public ResponseEntity<Sales> findById(@PathVariable Long id) {
		Sales obj = service.findById(id);
		return ResponseEntity.ok().body(obj);

	}

	@PostMapping
	public ResponseEntity<Sales> insert(@RequestBody Sales obj) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Sales> update(@PathVariable Long id, @RequestBody Sales obj) {
